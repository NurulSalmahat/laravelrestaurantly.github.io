...
<head>
  ...
  <title>Tambah Chef &mdash; Restaurantly</title>
          ...
          <div class="row">
            <div class="col-md-10">
              <div class="card card-primary">
                ...
                <div class="card-body">
                  <form method="post" action="{{ url('/chef') }}" class="needs-validation" novalidate=""
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input id="id_chef" type="text" class="form-control" name="id_chef" value="{{Session::get('id_chef')}}">
                        ...
                        <div class="form-group">
                            ...
                            <input id="posisi" type="text" class="form-control" name="posisi" value="{{Session::get('posisi')}}">
                            <div class="invalid-feedback">
                            </div>
                        </div>
