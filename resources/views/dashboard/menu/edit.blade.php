          ...
          <div class="row">
            <div class="col-md-10">
              <div class="card card-primary">
                ...
                <div class="card-body">
                  <form method="post" action="{{ url('menu/'  .$data->id) }}" class="needs-validation" novalidate=""
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input id="id_menu" type="text" class="form-control" name="id_menu" value="{{$data->id}}">
                        ...
                        <div class="form-group">
                            ...
                            <input id="menu" type="text" class="form-control" name="menu" value="{{$data->menu}}">
                            <div class="invalid-feedback">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input id="harga" type="text" class="form-control" name="harga" value="{{$data->harga}}">
                            <div class="invalid-feedback">
                            </div>
                        </div>
